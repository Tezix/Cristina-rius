        ...
        <>
            <div className="hero">
                <div className="text-column">
                    <h1 className="hero-title">Cristina Rius<span>{languagesData.homeHero.spanh1[language]}</span></h1>
                    <p className="hero-intro">{languagesData.homeHero.p[language]}</p>
                    <h2 className="hero-question">{languagesData.homeHero.h2[language]}</h2>
